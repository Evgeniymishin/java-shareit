...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    List<Booking> findAllByItemIdAndStatusEqualsOrderByStartAsc(Long itemId, Status status);

    List<Booking> findAllByItemIdAndStatusEqualsOrderByStartDesc(Long itemId, Status status);
